...
class AccountController extends AbstractController
{
    ...
    /**
     * Permet d'afficher et de tratier le formulaire de modification de profil
     *
    ...
    public function profile(Request $request, ObjectManager $manager)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $manager->persist($user); //optionnel
            $manager->flush();
    ...
    /**
     * Affiche la liste des réservations faites par l'user
     * 
