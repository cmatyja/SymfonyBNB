...
class User implements UserInterface
{
    ...
    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\Length(min=10, minMessage="Votre description courte doit faire 10 caractères minimum")
     */
    private $introduction;

    /**
     * @ORM\Column(type="text")
     * @Assert\Length(min=100, minMessage="Votre biographie doit faire 100 caractères minimum")
     */
    private $description;
    ...
    /**
     * Méthode implémtée de l'interface UserInterface qui permet
     * d'écraser des données sensibles stockées en clair dans l'objet
     *
     * @return void
     */
